...
var nameArray = [];
  nameArray.push('Marta');
  nameArray.push('Katona');

for (var i = genericNumberArray.length; i < 10 ; i++) {
...
var updatedOrders = orderQueue.concat({takeOut: 'lemon tart'}, {takeOut: 'Tiramisu'});
